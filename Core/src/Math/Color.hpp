#ifndef FLK_COLOR_HPP
#define FLK_COLOR_HPP
...
namespace Flock {
    ...
    struct FLK_API Color3 {
        ...
        static Color3 Green() { return Color3(0, 255, 0); }
        static Color3 Blue() { return Color3(0, 0, 255); }
...
#define EXPR(op)                                                                                                       \
    ...
    g op o;                                                                                                            \
    b op o
        FLK_MATH_ASSIGN_OPS(Color3, T, EXPR)
#undef EXPR
    };
